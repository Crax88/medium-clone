...
let TokensRepository = class TokensRepository {
    constructor(databaseService) {
        this.repository = databaseService.getRepository(token_entity_1.Token);
    }
    saveToken(userId, token) {
        return __awaiter(this, void 0, void 0, function* () {
            const newToken = this.repository.create({ userId, token });
            yield this.repository.save(newToken);
        });
    }
    deleteToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.repository.delete({ token });
        });
    }
    findToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.repository.findOneBy({ token });
        });
    }
};
